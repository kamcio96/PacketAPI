...
public class PacketDataWrapper {
    ...
    public static Object ServerPingPlayerSample(int players, int maxPlayers) {
        return new net.minecraft.server.v1_9_R1.ServerPing.ServerPingPlayerSample(players, maxPlayers);
    }

    public static Object ServerPingServerData(String name, int protocol) {
        return new net.minecraft.server.v1_9_R1.ServerPing.ServerData(name, protocol);
    }
